...
wpygV="22.9.27 V 0.3"
remoteV=`wget -qO- https://github.com/warplus/CFwarp/raw/main/CFwarp.sh | sed -n 4p | cut -d '"' -f 2`
red='\033[0;31m'
bblue='\033[0;34m'
yellow='\033[0;33m'
green='\033[0;32m'
...
wget -N https://github.com/warplus/CFwarp/raw/main/wgcf_2.2.15_$cpu -O /usr/local/bin/wgcf && chmod +x /usr/local/bin/wgcf         
if [[ $main -lt 5 || $minor -lt 6 ]] || [[ $vi =~ lxc|openvz ]]; then
[[ -e /usr/bin/wireguard-go ]] || wget -N https://github.com/warplus/CFwarp/raw/main/wireguard-go -O /usr/bin/wireguard-go && chmod +x /usr/bin/wireguard-go
fi
echo | wgcf register
...
warprefresh(){
wget -N https://github.com/warplus/CFwarp/raw/main/wp-plus.py 
...
wget -N https://github.com/warplus/CFwarp/raw/main/CFwarp.sh
chmod +x /root/CFwarp.sh 
ln -sf /root/CFwarp.sh /usr/bin/cf
...
echo -e "${bblue}     ░█${plain}█          ░██ ██ ██         ░██  ░░${red}██     ░██  ░░██     ░██  ░░██ ${plain}  "
echo
white " 甬哥Gitlab项目  ：github.com/rwkgyg"
